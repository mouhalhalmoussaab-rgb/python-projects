...
Le script principal compare les solutions numériques aux solutions analytiques pour différentes méthodes et valeurs du paramètre $r = \frac{V \Delta t }{ \Delta x}$.
